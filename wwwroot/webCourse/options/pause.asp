...
<html>
<head>
<title>World Wide Education</title>
</head>

<body style="margin:0" bgcolor="#000000" scroll="no">
<object ID="Scene" TYPE="application/x-oleobject"
  CLASSID="CLSID:86A88967-7A20-11D2-8EDA-00600818EDB1" WIDTH=100% height=100%   CODEBASE="ftp://210.36.82.244/cortvrml.exe">
  ...
  <param name="Scene" value="pause.wrl" ref>
  <param name="RendererName" value="R98 Renderer">
