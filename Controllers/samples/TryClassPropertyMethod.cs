...
using EDSS.Controllers.TryExtendedMethodForStringTypeNamespace;//定义扩展方法的静态类的名称空间
...
namespace EDSS.Controllers
{
    ...
    namespace TryExtendedMethodForStringTypeNamespace
    {
        ...
        {
            /// <summary>
            /// 为类定义一个静态方法，方法的第一个参数必须使用this关键字指定要使用扩展方法的现有类型，在此为System.String类型
            /// </summary>
            public static Int32 ToInt32(this String stringX,Boolean  boolean)
            {
                if(boolean)
                return Int32.Parse(stringX);
                else
                return -1;
            }
        }
